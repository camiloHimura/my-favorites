...
it('checking props tipes', () => {
  ...
  response = setPropTypes({component: Board, requiredValues, prop: 'setOptions', value: () =>{}})
  expect(response).toBeUndefined();
  ...
  response = setPropTypes({component: Board, requiredValues, prop: 'placeHolder', value: 'test 2'})
  expect(response).toBeUndefined();
  
  response = setPropTypes({component: Board, requiredValues, prop: 'Component', value: () => {}})
  expect(response).toBeUndefined();
