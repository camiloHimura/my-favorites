...
describe('Initial set up', () => {
  ...
  it('checking prop types', () => {
    ...
    expect(response).toBeUndefined();
    response = setPropTypes({component, requiredValues, prop: 'clearAfterSelecting', value: false})
    expect(response).toBeUndefined();
    response = setPropTypes({component, requiredValues, prop: 'clearList', value: true})
    expect(response).toBeUndefined();
    response = setPropTypes({component, requiredValues, prop: 'onTagsSaved', value: () => {}})
    expect(response).toBeUndefined();
