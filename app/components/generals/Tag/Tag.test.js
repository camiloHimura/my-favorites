...
const initialProps = {id: 'idTest', color: 'FFFF', name: 'testName', updateTag: jest.fn(), onClose: jest.fn()};
let component;
beforeEach(() => {
 component = setUp();
})
...
describe('edit mode', () => {
  ...
  it('updating tag', () => {
    ...
    findByTestAttr(component, 'input-edit').getElement().ref.current = {value: name};
    findByTestAttr(component, 'input-edit').simulate('keyPress', { key: 'Enter' });
